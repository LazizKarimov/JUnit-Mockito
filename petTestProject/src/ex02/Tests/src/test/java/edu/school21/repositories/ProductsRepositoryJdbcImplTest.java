...
public class ProductsRepositoryJdbcImplTest {
    ...
    final Product product1 = new Product(0L, "apple", 700);
    final Product product2 = new Product(1L, "samsung", 500);
    final Product product3 = new Product(2L, "huawei", 1000);
    final Product product4 = new Product(3L, "lg", 140);
    final Product product5 = new Product(4L, "motorolla", 540);
    ...
    final Product EXPECTED_UPDATED_PRODUCT = new Product(4L, "motorolla", 12234);

    final Product NEW_PRODUCT = new Product(null, "POSUDAMOYKAXOCHUPLEASKUPI", 13200);
